...
import kotlinx.android.synthetic.main.activity_finish_ballet.*
import java.text.SimpleDateFormat
import java.util.*


class FinishBalletActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_finish_ballet)
